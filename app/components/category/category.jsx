                ...
                <ReactSwipe swipeOptions={opt}>
                    ...
                    <div className="carousel-item">
                        <ul className="clearfix">
                            ...
                            <Link to="/search/xiuxianyule"><li className="float-left xuixianyule">休闲娱乐</li></Link>
                            ...
                            <Link to="/search/zuliao"><li className="float-left zuliaoanmo">足疗按摩</li></Link>
                    ...
                    <div className="carousel-item">
                        <ul className="clearfix">
                            ...
                            <Link to="/search/zhoubianyou"><li className="float-left shaokao">烧烤</li></Link>
                            <Link to="/search/shaokao"><li className="float-left jiazhuang">家装</li></Link>
